...
class Video():
    ...
    game2characters = {
        ...
        "崩坏三": ["爱莉希雅","崩三大鸭","薇塔","琪亚娜","幽兰戴尔","希儿","大月下","格蕾修",
                "素裳","希娜狄雅","阿波尼亚","德莉莎","萝莎莉娅"],
        "崩坏星穹铁道": ["卡夫卡","符玄","三月七","镜流","银狼","姬子","艾丝妲","黄泉",
                   "桂乃芬","阮梅","霍霍","黑塔","托帕","花火","流萤","黑天鹅","希露瓦"],
        "绝区零":["妮可"],
        
        # other game publisher
        "碧蓝航线":["Tashkent","能代","光辉","Bremerton","埃吉尔","圣路易斯","可畏",
                "曼切斯特"],
        "碧蓝档案":["晴奈","Plana","杏山千纱","カリン","尤卡","飛鳥馬トキ","一之濑明日奈","銀鏡伊織","莉音"],
        "幻塔":["陵光","凛夜","玉兰"],
        "战双帕弥什":["含英"],    
        "深空之眼":["英招"],    
        "明日方舟":[],    
