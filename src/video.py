...
class Video():
    ...
    game2characters = {
        ...
        # game
        "原神":["荧","神里凌华","雷电将军","甘雨","娜维娅","丝柯克","久岐忍",
              "刻晴","优菈","八重神子","夜兰","凝光","莫娜","丽莎","妮露","克洛琳德","迪希雅",
              "芙宁娜","申鹤","胡桃","纳西达","心海","北斗","芭芭拉","云堇","闲云","宵宫"], 
        "崩坏三": ["爱莉希雅","崩三大鸭","薇塔","琪亚娜","幽兰戴尔","希儿","大月下","格蕾修","梅比乌斯",
                "素裳","希娜狄雅","阿波尼亚","德莉莎","萝莎莉娅"],
        "崩坏星穹铁道": ["卡夫卡","符玄","三月七","镜流","银狼","姬子","艾丝妲","黄泉","克拉拉","知更鸟",
                   "桂乃芬","阮梅","霍霍","黑塔","托帕","花火","流萤","黑天鹅","希露瓦"],
        "绝区零":["妮可"],
        
        # other game publisher
        "碧蓝航线":["Tashkent","能代","光辉","Bremerton","埃吉尔","圣路易斯","可畏","拉菲","兴登堡","怨仇",
                "曼切斯特","信濃","安克雷奇"],
        "碧蓝档案":["晴奈","Plana","杏山千纱","カリン","尤卡","飛鳥馬トキ","仲正一花",
                "一之濑明日奈","銀鏡伊織","莉音"],
        "幻塔":["陵光","凛夜","玉兰"],
        "战双帕弥什":["含英"],    
        "深空之眼":["英招"],    
        "明日方舟":[],    
        "公主链接":["臭鼬"],
        "赛马娘":["Umamusume","东海帝皇","北部玄驹","成田大进","大和赤驥"],
        "机动战队":["陇"],
        "少女前线":["黛烟","PA-15"],
    ...
    gameNickname = \
    {
        ...
        "崩坏三":["女武神","bh3","honkai_impact_3","Honkai impact","崩坏3","honkai_impact"],    
        "绝区零":["ZZZ"],
        "幻塔":["塔"],    
    ...
    characterNickname = {
        ...
        "黑塔":["Herta"],
        "爱莉希雅":["爱莉","elysia","人之律者","🧁"],
        "幽兰戴尔":["呆鹅","幽兰黛尔","🦢","Bianka","Durandal","Ataegina"],
        "符玄":[],
        "克拉拉":["CLARA"],
        "素裳":[],
        "梅比乌斯":["🐍","蛇"],
        ...
        "Plana":["プラナ"],
        "晴奈":[],
        "莉音":["毁灭菇","Rio Tsukatsuki","Tsukatsuki"],
        "一之濑明日奈":[],
        "銀鏡伊織":[],
        "杏山千纱":["杏山千纱","Kazusa","Kazugasm","カズサ"],
        "カリン":["角楯","角楯花梨"],
        "尤卡":["ユウカ"],
        "飛鳥馬トキ":[],
        "仲正一花":["仲正","イチカ"],
